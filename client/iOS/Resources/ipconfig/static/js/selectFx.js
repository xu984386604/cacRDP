...
( function( window ) {
	...
	SelectFx.prototype._initEvents = function() {
		...
		//yosang
		// this.yPlaceholder.addEventListener('focus', function( ev ){
		// 	var ipinputHtml = "<div class='y-test-box'><input class='y-form-control-test y-address'></input><span>:</span><input class='y-form-control-test y-ipcontent y-ipcontent-one'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-two'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-three'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-four'></input></div>";
		// 	var ipaddhtml = "<span class='cs-addicon iconfont icon-plus'></span>";
		// 	self.doubleBox.innerHTML = ipinputHtml+ipaddhtml ;
	...
	SelectFx.prototype._toggleSelect = function() {
		...
		// 		//this.yPlaceholder.value = this.selectedOpt.textContent;
	...
	SelectFx.prototype._toggleInput = function() {
		...
		if( this._isFocus() ) {
			if(this.selectedOpt){
				var inputHtml = "<input class='y-form-control y-placeholder ipselect' value='"+self.selectedOpt.textContent+"'></input><span class='cs-placeholder iconfont icon-down'></span>";
			}else{
				var inputHtml = "<input class='y-form-control y-placeholder ipselect' value='' placeholder='ip配置'></input>";
			}
			self.doubleBox.innerHTML = inputHtml ;
			classie.remove( self.selEl, 'cs-focus' );
		}else{
			var ipinputHtml = "<div class='y-test-box'><input class='y-form-control-test y-address'></input><span>:</span><input class='y-form-control-test y-ipcontent y-ipcontent-one'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-two'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-three'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-four'></input></div>";
			var ipaddhtml = "<span class='cs-addicon iconfont icon-plus'></span>";
			self.doubleBox.innerHTML = ipinputHtml+ipaddhtml ;
