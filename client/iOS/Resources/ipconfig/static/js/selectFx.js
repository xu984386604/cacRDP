...
( function( window ) {
 ...
 this.selEl.innerHTML ="<div class='double-input-box'><input class='y-form-control y-placeholder ipselect' value='' placeholder='ip配置'></input></div> "+ opts_el;
 }
 ...
 document.addEventListener( 'click', function(ev) {
                           ...
                           if(self._isFocus() && target !== self.selEl && !hasParent( target, self.selEl ) ){
                           self._toggleInput();
                           }
                           } );
 ...
 // //yosang
 // this.yPlaceholder.addEventListener('click', function( ev ){
 // 	alert('shabi')
 // 	// console.log(this.addIpPlaceholder)
 // 	if(!self.addIpPlaceholder){
 // 		self.testSelEl = document.createElement( 'div' );
 // 		var ipinputHtml = "<div class='y-test-box'><input class='y-form-control-test y-address'></input><span>:</span><input class='y-form-control-test y-ipcontent y-ipcontent-one'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-two'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-three'></input><span>.</span><input class='y-form-control-test y-ipcontent y-ipcontent-four'></input><span>:</span><input class='y-form-control-test y-ipcontent y-ipcontent-five'></input></div>";
 // 		var ipaddhtml = "<span class='cs-addicon iconfont icon-plus' id='addip'></span>";
 // 		var html = ipinputHtml + ipaddhtml;
 // 		self.testSelEl.innerHTML = html;
 // 		self.doubleBox.appendChild(self.testSelEl);
 // 		self.addIpPlaceholder = self.selEl.querySelector('div.y-test-box');
 // 		self.csaddicon = self.selEl.querySelector('div.cs-addicon');
 // 		classie.add( self.yPlaceholder, 'y-hide' );
 // 		classie.remove( self.yPlaceholder, 'y-show' );
 // 		if(self.selPlaceholder){
 // 			classie.add( self.selPlaceholder, 'y-hide' );
 // 			classie.remove( self.selPlaceholder, 'y-show' );
 // 		}
 // 		classie.add( self.selEl, 'cs-focus' );
 // 	}else{
 // 		classie.add( self.addIpPlaceholder, 'y-show' );
 // 		classie.remove( self.addIpPlaceholder, 'y-hide' );
 // 		// classie.add( self.csaddicon, 'y-show' );
 // 		// classie.remove( self.csaddicon, 'y-hide' );
 // 		classie.add( self.yPlaceholder, 'y-hide' );
 // 		classie.remove( self.yPlaceholder, 'y-show' );
 // 		if(self.selPlaceholder){
 // 			classie.add( self.selPlaceholder, 'y-hide' );
